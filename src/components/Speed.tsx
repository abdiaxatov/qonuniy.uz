...
const translations = {
  ...
  uzb_cyr: {
    ...
    phone: "Телефон",
    profileName: "Soburov Xasanjon Shavkatjon o'g'li",
    profileDescription: `Веб-сайт эгаси Собуров Хасанжон Шавкатжон ўғли - ҳуқуқ магистри, 3-даражали юрист. Суд ва адлия органларида фаолият олиб борган. Барча ҳуқуқий масалаларда юридик ёрдам хизмати мавжуд. Телефон: `,
    close: "Ёпиш",
  },
};
